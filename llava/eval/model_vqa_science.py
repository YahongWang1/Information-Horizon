...
def configure_pruned(model, args):
    ...
    if args.sparse:
        ...
        model.config.pruned_config = pruned_config

    else:
        model.config.pruned_config = None
...
def eval_model(args):
    ...
    configure_pruned(model, args) # HACK: configure pruned
